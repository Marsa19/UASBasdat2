    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
		  ...
		  <div>	
			<a type="button" class="btn btn-primary" href="tambah_divisi.php">Tambah Divisi</a>
		  </div>
		  <br>
		  <div>
			<table id="example1" class="table table-bordered table-striped dataTable" aria-describedby="example1_info">
                  ...
                  <tbody role="alert" aria-live="polite" aria-relevant="all">
					...
					<tr class="odd">
                        ...
                        <td class=" ">
							<a type="button" class="btn btn-warning btn-xs" href="update_divisi.php?id=<?php echo $row['id_divisi'];?>">Update</a>
							<a type="button" class="btn btn-danger btn-xs" href="delete_divisi.php?id=<?php echo $row['id_divisi'];?>" onClick="return confirm('Menghapus data divisi <?php echo ucfirst($row['divisi']);?> ?');">Delete</a>
						</td>
                    </tr>
					<?php
							}
