    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#">Kepegawaian PT.APA</a>
        </div>
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
		  ...
		  <div>	
			<a type="button" class="btn btn-primary" href="tambah_pegawai.php">Tambah Pegawai</a>
		  </div>
		  <br>
		  <div>
			<table id="example1" class="table table-bordered table-striped dataTable" aria-describedby="example1_info">
                  ...
                  <tbody role="alert" aria-live="polite" aria-relevant="all">
					<?php 
						$result = $mysqli->query("select p.id_pegawai, p.nama, p.alamat, d.divisi
					...
					<tr class="odd">
                        ...
                        <td class=" "><?php echo ucfirst($row['nama']); ?></td>
                        <td class=" "><?php echo ucfirst($row['alamat']); ?></td>
                        <td class=" "><?php echo ucfirst($row['divisi']); ?></td>
                        <td class=" ">
							<a type="button" class="btn btn-warning btn-xs" href="update_pegawai.php?id=<?php echo $row['id_pegawai'];?>">Update</a>
							<a type="button" class="btn btn-danger btn-xs" href="delete_pegawai.php?id=<?php echo $row['id_pegawai'];?>" onClick="return confirm('Menghapus data pegawai <?php echo ucfirst($row['nama']);?> ?');">Delete</a>
						</td>
                    </tr>
					<?php
							}
